...
Get-WinEvent -LogName Security -MaxEvents 1000 -Verbose | Where-Object { $_.ID -eq 6416 } | Format-List  TimeCreated, AppName,  ProviderName, Id, Message | Out-File $env:userprofile\Desktop\Diag_result\Peripherique\Log_Drive_Connection.txt ;
